...
class radardata(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # preprocess to change range from [0,200] to [0,1]
        input_1 = input_1/200
        input_2 = input_2/200
        input_3 = input_3/200
        input_4 = input_4/200
...
def save_ckp(state, is_best, checkpoint_dir, best_model_dir):
    f_path = checkpoint_dir + 'u-net_with_resnet_logcosh_raw_new.pth'
...
if __name__=="__main__":
    ...
    ckp_path = save_path + 'u-net_with_resnet_logcosh_raw_new.pth'
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        for i, (input_1, input_2, input_3, input_4, output) in enumerate(dataloader):
            ...
            loss = logcosh_loss(outputs, output)
            loss.backward()
            optimizer.step()
            scheduler.step()
